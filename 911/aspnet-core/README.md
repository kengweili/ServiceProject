...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 42ad496f-921d-4a57-a966-049a994835b1
```

> `42ad496f-921d-4a57-a966-049a994835b1` is the password of the certificate, you can change it to any password you want.
