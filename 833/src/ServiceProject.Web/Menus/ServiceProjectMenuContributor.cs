...
namespace ServiceProject.Web.Menus;

public class ServiceProjectMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public ServiceProjectMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<ServiceProjectResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                ServiceProjectMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
